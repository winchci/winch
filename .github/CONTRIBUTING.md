...
First off, thank you for considering contributing to Winch.
...
Winch is an open source project and we love to receive contributions from our community — you! There are many ways to contribute, from writing tutorials or blog posts, improving the documentation, submitting bug reports and feature requests or writing code which can be incorporated into Winch itself. 
...
If you find yourself wishing for a feature that doesn't exist in Winch, you are
probably not alone. There are bound to be others out there with similar needs.
Many of the features that Winch has today have been added because our users saw
