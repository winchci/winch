...
var Assets = func() http.FileSystem {
	fs := vfsgen۰FS{
		"/": &vfsgen۰DirInfo{
			name:    "/",
			modTime: time.Date(2021, 4, 18, 18, 54, 50, 337419490, time.UTC),
		},
		"/VERSION.tmpl": &vfsgen۰FileInfo{
			name:    "VERSION.tmpl",
			modTime: time.Date(2021, 4, 18, 18, 54, 50, 337276452, time.UTC),
		...
		"/circleci.tmpl": &vfsgen۰CompressedFileInfo{
			name:             "circleci.tmpl",
			modTime:          time.Date(2020, 12, 10, 0, 0, 56, 565611597, time.UTC),
		...
		"/version_py.tmpl": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2021, 4, 18, 18, 45, 0, 95053422, time.UTC),
			uncompressedSize: 89,
