...
var Assets = func() http.FileSystem {
	fs := vfsgen۰FS{
		"/": &vfsgen۰DirInfo{
			name:    "/",
			modTime: time.Date(2020, 6, 2, 8, 13, 46, 228009561, time.UTC),
		},
		...
		"/docker_action.tmpl": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2020, 6, 2, 8, 13, 46, 226167790, time.UTC),
		...
		"/go_action.tmpl": &vfsgen۰CompressedFileInfo{
			name:             "go_action.tmpl",
			modTime:          time.Date(2020, 6, 2, 8, 13, 46, 226382091, time.UTC),
		...
		"/go_dockerfile.tmpl": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2020, 6, 2, 8, 13, 46, 226669333, time.UTC),
		...
		"/java_mvn_action.tmpl": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2020, 6, 2, 8, 13, 46, 226889779, time.UTC),
		...
		"/node_action.tmpl": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2020, 6, 2, 8, 13, 46, 227107930, time.UTC),
		...
		"/python_action.tmpl": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2020, 6, 2, 8, 13, 46, 227322263, time.UTC),
		...
		"/scala_sbt_action.tmpl": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2020, 6, 2, 8, 13, 46, 227538095, time.UTC),
